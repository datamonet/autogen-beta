...
export default function ChatInput({
  ...
  return (
    <div className="mt-2 w-full">
      ...
      <div
        className={`mt-2 rounded shadow-sm flex mb-1 transition-all duration-200 ${dragOver ? "ring-2 ring-blue-400" : ""
      ...
      >
        ...
        >
          ...
          <textarea
            ...
            className={`flex items-center w-full resize-none text-gray-600 rounded ${dragOver
          ...
          <div className={`absolute right-3 bottom-2 flex gap-2`}>
            <div
              className={`   ${disabled || isInputDisabled
            ...
            <button
              ...
              className={`bg-accent transition duration-300 rounded flex justify-center items-center w-11 h-9 ${isInputDisabled || (text.trim() === "" && fileList.length === 0)
